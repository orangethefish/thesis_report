...
\input{Sections/01_ListOfImages}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Sections/02_ListOfTable}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\fancyfoot{} % clear all footer fields
...
\newpage\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Sections/04_TheoreticalBasis}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Sections/05_SystemArchitecture}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Sections/06_SystemImplementation}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Sections/07_ImprovedMethods}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Sections/07_ExperimentalResults}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
